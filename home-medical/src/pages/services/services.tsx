...
import { ServiceItemControl } from "../../controls";
...
function ServicesPage() {
	...
	let serviceItems: Array<ServiceItem> = [
		{
	...
	let serviceItemControls = serviceItems.map((item) => (
		<ServiceItemControl {...item}></ServiceItemControl>
	));
	return (
		<div className="services-page">
			<img className="page-background" src={BackgroundImage}></img>
			{serviceItemControls}

			<CSSTransition timeout={200} classNames="my-node">
				<div className="service-description frost-background light-shadow">
					<Switch>
						<Route
						...
						<Route exact={true} path={match.path}>
							{({ match }) => (
								<CSSTransition
									...
									classNames="page"
									unmountOnExit>
									<div className="page">lalalal</div>
								</CSSTransition>
							)}
						</Route>
					</Switch>
