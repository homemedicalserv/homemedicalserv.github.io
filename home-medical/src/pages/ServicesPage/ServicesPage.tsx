...
import { ServiceItem, UnderConstruction, ServiceDescription } from '../../components';
...
const ServicesPage: React.FC = () => {
	...
	let serviceItems: Array<ServiceItemModel> = [
		...
		{
			title: 'De ce să alegi HOME MEDICAL SERV SRL?',
			icon: 'prescription',
			url: '',
		},
	];
			...
			<div>
				<Switch>
					<Route path={`${match.path}/ingrijiri-medicale-la-domiciliu`}>
						<ServiceDescription>
							<p>
								Îngrijirea medicală la domiciliu este un serviciu la care tot mai mulți pacienți apelează pentru a nu fi
								nevoiți sa ramană în spital.
							</p>
							<p>
					...
					<Route path={`${match.path}/transport-sanitar-neasistat`}>
						<ServiceDescription>
							...
							<p>
								...
								transport special, dar nu pot apela la <b>serviciul public de ambulanta</b> pentru ca nu prezinta un caz
								de urgenta medicala.
							</p>
							<p>
					...
					<Route exact={true} path={match.path}>
						<ServiceDescription>
							<ul>
								...
								<li>Respect pentru pacient </li>
								<li>Punctualitate</li>
								<li>Devotament și empatie</li>
								<li>Personal calificat</li>
								<li>Cele mai rapide, potrivite și deontologice soluții de transport sanitar neasistat</li>
							</ul>
						</ServiceDescription>
					</Route>
				</Switch>
